...
const StudentInfo =
  models.StudentInfo || model("StudentInfo", studentInfoSchema);
const StaffInfo = models.StaffInfo || model("StaffInfo", staffInfoSchema);
const EsewaPaymentInfo =
  models.EsewaPaymentInfo || model("EsewaPaymentInfo", esewaPaymentRecord);
const GradeInfo = models.Grade || model("Grade", gradeSchema);
const FeesRecordInfo =
  models.FeesRecordInfo || model("FeesRecordInfo", feesRecord);
